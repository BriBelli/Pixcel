  ...
  function RailBtn(props) {
    ...
    return (
      <button onClick={props.onClick} ref={props.btnRef} title={props.hint ? props.label + '  (' + props.hint + ')' : props.label}
        ...
        {/* active edge marker */}
        {false && props.active && <span style={{ position: 'absolute', left: -10, top: '50%', transform: 'translateY(-50%)',
          width: 2, height: 24, borderRadius: 9999, background: 'var(--pxs-accent-text)' }} />}
        {props.children}
